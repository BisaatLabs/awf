...
export const spaces: Space[] = [
  {slug:'home', name:'Home', eyebrow:'01 / HOME', description:'Pieces designed around the way you live, from daily dining to the quiet corners you return to.', image:images.dining, products:['Dark Walnut Gold Filigree Storage Bed', 'White Gold Medallion Six-Door Wardrobe', 'Six-Door Copper Brown Wardrobe']},
  {slug:'office', name:'Office', eyebrow:'02 / OFFICE', description:'Furniture designed for the way your team works, with considered details that keep the day moving.', image:images.workspace, products:['Slim Computer Desk', 'Black Office Desk', 'Pale Wood Office Desk']},
  {slug:'corporate', name:'Corporate', eyebrow:'03 / CORPORATE', description:'A dependable furniture language for workplaces, meeting rooms and reception areas.', image:images.conference, products:['Three-Tier Shelf Table', 'Green Ornate Frame Table', 'Woodgrain X-Frame Table']},
  {slug:'school', name:'School', eyebrow:'04 / SCHOOL', description:'Built for daily use. Ready for every batch, every lesson and every shared space.', image:images.office, products:['Pale Wood School Desk Set', 'Blue Student Desk Unit', 'Turquoise Frame School Bench']},
  {slug:'institutional', name:'Institutional', eyebrow:'05 / INSTITUTIONAL', description:'Practical, durable furniture packages developed for the rhythm of institutions.', image:images.wood, products:['Black Standard Bunk Bed', 'Silver Arched Bunk Bed', 'Gray Cafeteria Table Bench Set']},
];
